defmodule MetalMeetingWeb.Router do
  use MetalMeetingWeb, :router

  import MetalMeetingWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {MetalMeetingWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: MetalMeetingWeb.Telemetry
    end
  end
